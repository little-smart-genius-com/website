...
def fix_json(file_path, fixes):
    ...
    if 'content' not in data:
        print("No content key in", file_path)
        return
...
for f in stem5_files:
    fix_json(f, [
        lambda c: c.replace('stem-building-challenges-for-kids-using-craft-sticks-4-proven-mistakes-to-avoid-img4-1780740781.webp', 'stem-building-challenges-for-kids-using-craft-sticks-5-proven-mistakes-to-avoid-img4-1780740781.webp'),
