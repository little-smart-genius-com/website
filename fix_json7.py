...
if idx != -1:
    ...
    if end_idx != -1:
        c = c[:idx] + "fine-motor-busy-book-pages-for-toddlers-printable-best-resources-img4-1779274813.webp' alt='fine motor' loading=" + c[end_idx+8:]
        d['content'] = c
...
if idx2 != -1:
    ...
    if end_idx2 != -1:
        c2 = c2[:idx2] + "how-spot-the-difference-activities-sharpen-focus-in-6-year-olds-img5-1777027855.webp' alt='spot the difference' loading=" + c2[end_idx2+8:]
        d2['content'] = c2
