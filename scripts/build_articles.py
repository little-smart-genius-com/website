...
# ── Canonical URL map (content cannibalization fix) ──
# Generated by scripts/fix_canonical_clusters.py --apply
_canonical_map_path = os.path.join(PROJECT_ROOT, "canonical_map.json")
CANONICAL_MAP = {}
if os.path.exists(_canonical_map_path):
    try:
        with open(_canonical_map_path, "r", encoding="utf-8") as _f:
            CANONICAL_MAP = json.load(_f)
        print(f"  ℹ Loaded canonical_map.json ({len(CANONICAL_MAP)} redirects)")
...
<head>
    ...
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;800&family=Source+Serif+4:ital,opsz,wght@0,8..60,300;0,8..60,400;0,8..60,600;1,8..60,400&display=swap">
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;800&family=Source+Serif+4:ital,opsz,wght@0,8..60,300;0,8..60,400;0,8..60,600;1,8..60,400&display=swap" rel="stylesheet" media="print" onload="this.media='all'">
    <noscript><link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;800&family=Source+Serif+4:ital,opsz,wght@0,8..60,300;0,8..60,400;0,8..60,600;1,8..60,400&display=swap" rel="stylesheet"></noscript>
    ...
    <main class="pt-[100px] pb-10 px-5 md:px-10">
        ...
        <article class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-10">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 text-sm font-bold mt-4" style="color: #64748B;">
...
def generate_article_html(json_data: dict, slug: str, all_articles=None, prev_article=None, next_article=None, tpt_products=None, freebies=None) -> str:
    ...
    author_url = f"/authors/{author_name.lower().replace(' ', '-')}.html"
    ...
    # Canonical URL — use pillar page if this article is a non-pillar in a cluster
    canonical_url = f"{SITE_URL}/articles/{slug}.html"
    if slug in CANONICAL_MAP:
        canonical_url = CANONICAL_MAP[slug]["canonical_url"]
        print(f"    ↳ Canonical override: → {CANONICAL_MAP[slug].get('pillar_slug', '')}")
